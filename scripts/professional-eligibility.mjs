/** Qualification gate: duties rank jobs but never decide whether a major may apply. */
...
const BROAD_ENGINEERING = /(工学(?:门类|全类|类|专业)|所有工学|理工(?:科|类|专业|背景|方向|等|及|、|，|\/|$)|工程(?:类|门类|学科))/i;
